...
FilterTable = (
  ...
  re.compile(r'\Ahttp://gendai\.net/'), # 理由: title要素に記事名が含まれていないため
  re.compile(r'\Ahttp://ja\.espnf1\.com/'), # 理由: 記事名が文字化け、かつ鉄道関連のニュースが含まれないため
  ...
  re.compile(r'\Ahttp://mainichi\.jp/enta/sports/baseball/news/m'), # 理由: title要素に記事名が含まれていないため
  re.compile(r'\Ahttp://mainichi\.jp/life/money/kabu/nsj/news/'), # 理由: title要素に記事名が含まれていないため
  re.compile(r'\Ahttp://mainichi\.jp/select/.+?/news/m'), # 理由: title要素に記事名が含まれていないため
  ...
  re.compile(r'\Ahttp://news\.rkb\.ne\.jp/'), # 理由: title要素に記事名が含まれていないため
  ...
  re.compile(r'\Ahttp://sports\.nikkei\.co\.jp/'), # 理由: title要素に記事名が含まれていないため
  ...
  re.compile(r'\Ahttp://www\.muromin\.mnw\.jp/'), # 理由: title要素に記事名が含まれていないため
  ...
  re.compile(r'\Ahttp://www\.rkk\.co\.jp/'), # 理由: title要素に記事名が含まれていないため
