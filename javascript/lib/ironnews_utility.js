...
//<CleanseTitleTable>
  ...
  "rocketnews24.com": [[/^(.+) – ロケットニュース24（β）$/, "$1"]],
  ...
  "www.bloomberg.co.jp": [[/^(.+) - Bloomberg\.co\.jp$/, "$1"]],
  ...
  "www.ehime-np.co.jp": [[/^(.+) 愛媛新聞社ONLINE$/, "$1"]],
  "www.fnn-news.com": [[/^FNNニュース: (.+)$/, "$1"]],
  "www.gifu-np.co.jp": [[/^(.+)(?: |　−　)岐阜新聞 Web$/, "$1"]],
  "www.hokkaido-np.co.jp": [[/^(.+)−北海道新聞\[.+\]$/, "$1"]],
  "www.j-cast.com": [[/^(.+) : J-CAST(?:ニュース|会社ウォッチ|モノウォッチ|テレビウォッチ)$/, "$1"],[/^(.+) \(\d+\/\d+\)$/, "$1"]],
  "www.jiji.com": [[/^時事ドットコム：(.+)$/, "$1"]],
  "www.kahoku.co.jp": [[/^河北新報　(?:東北|内外)のニュース／(.+)$/, "$1"],[/^河北新報 (.+)$/, "$1"]],
  "www.kfb.co.jp": [[/^(.+) :: 福島県内ニュース :: KFB福島放送$/, "$1"]],
  "www.kobe-np.co.jp": [[/^神戸新聞｜(.+)$/, "$1"],[/^全国海外ニュース｜(.+)$/, "$1"],[/^(?:淡路|阪神・北摂|姫路・西播磨|但馬|東播磨|神戸)｜(.+)$/, "$1"],[/^(?:事件・事故|社会|文化|経済)｜(.+)$/, "$1"]],
  "www.kyoto-np.co.jp": [[/^(.+)：京都新聞$/, "$1"]],
  "www.mutusinpou.co.jp": [[/^(.+) by 陸奥新報$/, "$1"]],
  "www.nagasaki-np.co.jp": [[/^龍〜なが　長崎新聞ホームページ：(.+)$/, "$1"]],
  "www.nhk.or.jp": [[/^NHKニュース　(.+)$/, "$1"]],
  "www.nikkansports.com": [[/^(.+) : nikkansports.com$/, "$1"]],
  ...
  "www.shimotsuke.co.jp": [[/^(.+) ｜下野新聞「ＳＯＯＮ」$/, "$1"]],
